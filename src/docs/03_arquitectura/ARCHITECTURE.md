...
**Justificación:** Dado el tamaño mediano de la aplicación, Redux sería excesivo. Context API provee suficiente capacidad para evitar _prop-drilling_ sin añadir complejidad de boilerplate.
